export const CATEGORIES = [
  ...
  { id: "smart-plug", name: "Ổ cắm thông minh" },
  { id: "smart-switch", name: "Công tắc thông minh" },
  { id: "sensor", name: "Cảm biến" },
  { id: "smart-light", name: "Đèn thông minh" },
  { id: "smart-lock", name: "Khóa thông minh" },
  { id: "smart-speaker", name: "Loa thông minh" },
  { id: "smart-tv", name: "TV thông minh" },
  { id: "smart-ac", name: "Điều hòa thông minh" },
  { id: "other", name: "Khác" },
];
...
export const BRANDS = [
  ...
  // { id: " Philip-hue", name: "Philips Hue" },
  // { id: "sonoff", name: "Sonoff" },
  { id: "ezviz", name: "Ezviz" },
  { id: "imou", name: "Imou" },
  // { id: "rongta", name: "Rongta" },
  { id: "smartlife", name: "SmartLife" },
  { id: "tuya", name: "Tuya" },
